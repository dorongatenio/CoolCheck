...
function create_tree_2() {
    //שאלת פתיחה
    let q1 = new Node("האם שיחון יתר( Superheat)תקין?בצע בדיקה  שטמפרטורת גז ביציאה מהמאייד גבוהה ב- º 8 - º 5 מטמפרטורה בשעון LP", null, null);
    //אם שאלה 1 היא לא
    let q2 = new Node("האם Δθ אוויר קטן למדי? ", null, null);
    //אם שאלה 2 היא לא
    let q3 = new Node("חוסר בזרימת אוויר על סוללת המאייד ", null, null);
    //אם שאלה 2 היא כן 
    let q4 = new Node("מאייד מלוכלך או שהחלפת החום ירודה", null, null);
    //אם שאלה 1 היא כן
    let q5 = new Node("האם קירור יתר (subcooling) תקין? בצע בדיקה שטמפרטורה ביציאה מהמעבה נמוכה ב- º 7 - º 4 מטמפרטורה בשעון HP", null, null);
    //אם שאלה 5 היא כן
    let q6 = new Node("האם Δθ בקו הנוזל?בצע בדיקה ש- ΔT  בין היציאה מהמעבה לטמפרטורה בכניסה לשסתום ההתפשטות אינו גדול מ- º 2", null, null);
    //אם שאלה 5 היא לא 
    let q7 = new Node("חוסר בקרר ", null, null);
    //אם שאלה 6 היא כן 
    let q8 = new Node("התפשטות מוקדמת בקו נוזל, החלף מסנן ", null, null);
     //אם שאלה 6 היא לא 
    let q9 = new Node("תקלה בשסתום", null, null);
...
function create_tree_3() {
    let q1 = new Node("האם קירור יתר (subcooling) תקין? בצע בדיקה שטמפרטורה ביציאה מהמעבה נמוכה ב- º 7 - º 4 מטמפרטורה בשעון HP", null, null);
    //אם שאלה 1 כן
    let q2 = new Node("האם קיימים גזים בלתי מעובים? (אוויר, חנקן) ", null, null);
    //אם שאלה 2 היא כן
    let q3 = new Node("קיימים בלתי מעובים", null, null);
    //אם שאלה 2 היא לא 
    let q4 = new Node("עודף בקרר ", null, null);
 //אם שאלה 1 היא לא
    let q5 = new Node("ירידת תפוקה של מעבה ", null, null);
//בהכרח בא אחרי אין כן או לא
    let q6 = new Node("האם Δθ על האוויר קטן?  בדוק את חוסר תפוקת הקירור של המעבה - קירור יתר גבוה? ", null, null);
 //אם שאלה 6 היא כן
    let q7 = new Node("מעבה מלוכלך או שהחלפת החום של המעבה ירודה ", null, null);
 //אם שאלה 6 היא לא
    let q8 = new Node("חוסר זרימת אוויר על סוללת המעבה ", null, null);
...
function onloadpage(id_in) {
    ...
    if (id_in == "Tree1") {
        ...
        title.innerText = "לחץ יניקה גבוה (HP)";
        p = document.getElementById("swiping_p");
        p.innerText = "ענו על השאלות בהתאם לבדיקות ואתרו את התקלה";
    } else if (id_in == "Tree2") {
        current = create_tree_2();
        title = document.getElementById("swiping_title");
        title.innerText = "לחץ יניקה נמוך (LP)";
        p = document.getElementById("swiping_p");
        p.innerText = "ענו על השאלות בהתאם לבדיקות ואתרו את התקלה";
    } else if (id_in == "Tree3") {
